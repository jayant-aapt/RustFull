...
impl Config {
    pub fn new() -> Self {
        ...
        let config = Self {
            ...
            client_cert_path: env::var("CLIENT_CERT_PATH").unwrap_or_else(|_| format!("{}/nats/nats_config/certificate/client-cert.pem", app_dir)),
            client_key_path: env::var("CLIENT_KEY_PATH").unwrap_or_else(|_| format!("{}/nats/nats_config/certificate/client-key.pem", app_dir)),
